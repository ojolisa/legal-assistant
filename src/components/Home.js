...
const  Home = (props) => {
  ...
  const handlescrolltoservice = (event)=>{
    event.preventDefault();
     const element = document.querySelector('.service-section');
     window.scrollTo({
      top:element.offsetTop,
      behavior:'smooth'
    });
    ...
    <>
     <Container>
        <Navbar>
          ...
          <Navmenu>
            <ul>
              ...
              <li>
                <Link to="/" onClick={handlescrolltoservice}>SERVICES</Link>
              </li>
              <li>
        ...
        <Maincontent>
          ...
          <div></div>
          <span className="details">GET SOLUTIONS FOR ALL YOUR LEGAL ISSUES HERE</span>
        </Maincontent>
      </Container>
    <AboutNew/>
    <Services/>
...
background-color: rgb(73 73 73 / 64%);
